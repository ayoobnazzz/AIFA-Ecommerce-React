      ...
      <div className="filters-field">
        ...
        {products.length === 0 && isLoading ? (
          ...
          >
            ...
            <option value="babyBlossom">Baby Blossom</option>
            <option value="happyHuggies">Happy Huggies</option>
            <option value="cuddleCloud">CuddleCloud</option>
            <option value="gentleBeginnings">Gentle Beginnings</option>
          </select>
        )}
      </div>
      <div className="filters-field">
